...
public abstract class Conexao {
    ...
    public static Connection getConnection() throws SQLException {
        String conecaoMysql = "jdbc:mysql://"+ HibernateConfiguration.getHost() +"/?user=" + HibernateConfiguration.getUserName() +
                "&password=" + HibernateConfiguration.getPassword();
        if (conexao == null) {
    ...
    public static Connection getConnectionJasper() throws SQLException {
        String conecaoMysql = "jdbc:mysql://"+ HibernateConfiguration.getHost() +"/" + HibernateConfiguration.getDataBase()
                + "?user=" + HibernateConfiguration.getUserName() + "&password=" + HibernateConfiguration.getPassword();
